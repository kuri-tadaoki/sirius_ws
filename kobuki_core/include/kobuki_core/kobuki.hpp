...
public:
  ...
  //bool Start_odom_flg() const { return start_odom_flg; }
  ...
  *******************************************/
  ...
  ecl::Angle<double> getHeading0() const;
  // ecl::Angle<double> getHeading2() const;
  ...
  **********************/
  ...
  void updateOdometry0(ecl::linear_algebra::Vector3d &pose_update,
