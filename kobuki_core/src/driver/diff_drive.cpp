...
DiffDrive::DiffDrive() :
  ...
  bias(0.485), // wheelbase, wheel_to_wheel, in [m]
  wheel_radius(0.18), // radius of main wheel, in [m]
  tick_to_rad(0.00071674029f), //0.002436916871363930187454f
...
void DiffDrive::update0(const uint16_t &time_stamp,
  ...
  m_heading += pose_update_rates[2]*last_diff_time;
